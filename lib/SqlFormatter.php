...
class SqlFormatter
{
    ...
    public static $quote_attributes = 'style="color: #0000FF;"';
    ...
    public static $word_attributes = 'style="color: #000080;"';
    public static $error_attributes = 'style="background-color: red;"';
    public static $comment_attributes = 'style="color: red;"';
    public static $variable_attributes = 'style="color: orange;"';
    public static $pre_attributes = 'style="color: #008080; background-color: white;"';
